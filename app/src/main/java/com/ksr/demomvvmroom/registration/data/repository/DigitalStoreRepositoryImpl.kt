...
public class DigitalStoreRepositoryImpl(private val dao: DigitalStoreDao): DigitalStoreRepository {
    ...
    override suspend fun addCustomerOnDb(customer: DigitalStoreEntity) = dao.addCustomerOnDb(customer)

    override suspend fun updateCustomerOnDb(customer: DigitalStoreEntity) = dao.updateCustomerOnDb(customer)

    override suspend fun deleteCustomerOnDb(customer: DigitalStoreEntity) = dao.deleteCustomerOnDb(customer)
